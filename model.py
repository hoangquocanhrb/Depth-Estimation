...
class PSPNet(nn.Module):
    def __init__(self, n_classes):
        ...
        self.pyramid_pooling = PyramidPooling(in_channels=2048, pool_sizes=[6, 3, 2, 1], height=img_size_8[0], width=img_size_8[1])
        
        # decode module
        self.decode_feature = DecodePSPFeature(height=img_size[0], width=img_size[1], n_classes=n_classes)
        
        # auxloss module
        self.aux = AuxilirayPSPLayers(in_channels=1024, height=img_size[0], width=img_size[1], n_classes=n_classes)
